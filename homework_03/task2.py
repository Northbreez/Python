...
likefilms = []
numfilms = int(input('Сколько фильмов хотите добавить? '))
while numfilms != 0:
    enterfilms = input("Введите название фильма: ")
    if enterfilms in films:
        likefilms.append(enterfilms)
    else:
        print(f'Ошибка: фильма "{enterfilms}" у нас нет :( ')
    numfilms -= 1
